...
## 키워드 큐레이션 — 필요 키워드 추가 + 불필요 키워드 삭제 (2026-04-12 완료)

- [x] 현재 전체 키워드 목록 파악 (data.js에서 ID 추출)
- [x] 누락된 중요 키워드 후보 선정 — AI 분야 핵심 개념 중 빠진 것
- [x] 불필요/중복/너무 세부적인 키워드 식별
- [x] 사용자 확인 — 추가/삭제 목록 승인
- [x] 승인된 키워드 추가 (fetch-sources.js → 에이전트 → data.js)
- [x] 승인된 키워드 삭제 → 해당 없음
- [x] 빌드 (node build.js) + 검증

### 결과
- 245개 → 248개 (3개 추가: AGI, 스케일링 법칙, GAN)
- 삭제 대상 없음 — 기존 245개 모두 유지
- 추가 수정: 모바일 관계도 잘림 수정, 최근 업데이트 줄바꿈, 본문-태그 간격, 로고 링크 SPA화

### 진행 로그
| 시간 | 작업 내용 |
|------|----------|
| 2026-04-11 | 플랜 시작, 245개 키워드 카테고리별 분석 |
| 2026-04-11 | 추가 후보 3개(AGI, Scaling Law, GAN), 삭제 없음 확정 |
| 2026-04-11 | 모바일 버그 3건 수정 (관계도 클램핑, grid-header 줄바꿈, 태그 간격) |
| 2026-04-12 | fetch-sources.js로 3개 키워드 소스 수집, 에이전트 병렬 실행 |
| 2026-04-12 | data.js 반영 (248개), build.js 실행 완료 |
